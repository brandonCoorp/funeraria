...
( apellidoP ) {return new Symbol(sym.apellidoP, yychar, yyline, yytext());}
( apellidoM ) {return new Symbol(sym.apellidoM, yychar, yyline, yytext());}
( descripcion ) {return new Symbol(sym.descripcion, yychar, yyline, yytext());}
( direccion ) {return new Symbol(sym.direccion, yychar, yyline, yytext());}
( telefono ) {return new Symbol(sym.telefono, yychar, yyline, yytext());}
( tipo ) {return new Symbol(sym.tipo, yychar, yyline, yytext());}

( id ) {return new Symbol(sym.id, yychar, yyline, yytext());}


( cod_item ) {return new Symbol(sym.cod_item, yychar, yyline, yytext());}
( cantidad ) {return new Symbol(sym.cantidad, yychar, yyline, yytext());}
( estado ) {return new Symbol(sym.estado, yychar, yyline, yytext());}
( costo_unitario ) {return new Symbol(sym.costo_unitario, yychar, yyline, yytext());}

( sucursal_id ) {return new Symbol(sym.sucursal_id, yychar, yyline, yytext());}
( persona_id ) {return new Symbol(sym.persona_id, yychar, yyline, yytext());}

( sucursal ) {return new Symbol(sym.sucursal, yychar, yyline, yytext());}
( item ) {return new Symbol(sym.item, yychar, yyline, yytext());}
( servicio ) {return new Symbol(sym.servicio, yychar, yyline, yytext());}
( fecha ) {return new Symbol(sym.fecha, yychar, yyline, yytext());}
( fecha_entrega ) {return new Symbol(sym.fecha_entrega, yychar, yyline, yytext());}
( paquete ) {return new Symbol(sym.paquete, yychar, yyline, yytext());}
( pago ) {return new Symbol(sym.pago, yychar, yyline, yytext());}
( compra_id ) {return new Symbol(sym.compra_id, yychar, yyline, yytext());}
( motivo ) {return new Symbol(sym.motivo, yychar, yyline, yytext());}


( rol ) {return new Symbol(sym.rol, yychar, yyline, yytext());}

( cod_servicio ) {return new Symbol(sym.cod_servicio, yychar, yyline, yytext());}
( cod_paquete ) {return new Symbol(sym.cod_paquete, yychar, yyline, yytext());}
( costo ) {return new Symbol(sym.costo, yychar, yyline, yytext());}
( mail ) {return new Symbol(sym.mail, yychar, yyline, yytext());}
