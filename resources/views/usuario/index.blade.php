        ...
        <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch flex-column">
          <div class="card bg-light d-flex flex-fill">
            ...
            <div class="card-body pt-0">
              <div class="row">
                <div class="col-7">
                  <h2 class="lead"><b>{{$usuario->nombre}} {{$usuario->apellido_paterno}} {{$usuario->apellido_materno}}</b></h2>
                  ...
                  <ul class="ml-4 mb-0 fa-ul text-muted">
                    ...
                    <li class="small"><span class="fa-li"><i class="fas fa-birthday-cake"></i></span> Fecha_Naci :  {{$usuario->fecha_nac}} </li>
                  </ul>
                </div>
                <div class="col-5 text-center">
                  <img src="{{ asset($usuario->foto)}}" alt="user-avatar" class="img-circle img-fluid">
                </div>
              </div>
            </div>
