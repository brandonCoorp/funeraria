             ...
             <div class="form-group">
                ...
                <form action="{{route('reportes')}}" method="POST" id="formReporte">
                 ...
                 <select class="form-control selectOption" name="selectReporte" id="selectReporte" required>
                     ...
                     <option  class="selectOption" selected value="usuarios">Usuarios</option>
                    ...
                    <table id="reportes" class="table table-bordered table-striped">
                      ...
                      <tbody>
                        ...
                        <td>{{$dato->persona->apellido_paterno}}</td>
                        <td>{{$dato->persona->apellido_materno}}</td>
                        <td>{{$dato->persona->direccion}}</td>
                        <td>{{$dato->usuariofotofechas[0]->fecha_nac->format('Y-m-d')}}</td>
                        <td>{{$dato->mail}}</td>
                        <td>{{$dato->role->nombre}}</td>
                    </tr>        
                        @endforeach
